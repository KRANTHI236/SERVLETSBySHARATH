package com.jsp.management.jspmanagement.config;
...
@ComponentScan(value="com.jsp.management.jspmanagement.repository")
...
//		log.info("properties loaded..");
	...
	public LocalSessionFactoryBean sessionFactory(){
		...
		sessionFactory.setPackagesToScan(new String[] { "com.jsp.management.jspmanagement.entity" });
		//sessionFactory.setPackagesToScan(new String[] { "com.practiece.springmvccrud.entity" });
